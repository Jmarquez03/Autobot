...
class StatePublisher(Node):
    def __init__(self):
        ...
        # This node now only monitors cmd_vel for debugging with ros2_control
        ...
        self.wheel_separation = 0.15  # Must match controller config
        
        # Node initialization
        self.get_logger().info(f"{self.get_name()} started - monitoring ackermann_controller/cmd_vel")
